...
public class GerenciadoraClientesTest_Ex10 {
	...
	public void setUp() {
		...
		Cliente cliente01 = new Cliente(idCLiente01, "Johnathan Ciqueira", 31, "johnathan.ciqueira@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Johnathan", 25, "johnathan@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_02() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Johnathan", 18, "johnathan@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_03() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Johnathan", 65, "johnathan@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_04() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Johnathan", 17, "johnathan@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_05() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Johnathan", 66, "johnathan@gmail.com", 1, true);
		/* ========== Execução ========== */
		try {
			gerClientes.validaIdade(cliente.getIdade());
			fail();
